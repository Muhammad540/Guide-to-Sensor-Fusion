...
def generate_launch_description():
    ...
    # map_server_config_file = LaunchConfiguration('map_file')
    ...
    #     'map_file',
    #     default_value=os.path.join(get_package_share_directory(package_name), 'params', 'map_server_params.yaml'),
    #     description='Full path to the ROS2 mapserver yaml config file to use for the mapserver node')
    
    # declare_map_yaml_cmd = DeclareLaunchArgument(
    #     'map', 
    #     default_value=os.path.join(get_package_share_directory(package_name), 'maps', 'map.yaml'),
